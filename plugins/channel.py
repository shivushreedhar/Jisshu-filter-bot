...
CAPTION_LANGUAGES = [
    "Bhojpuri", "bho", "bhojp", "Hindi", "hin", "hindi", "Bengali", "ben", "bengali",
    "Bangla", "bangla", "bang", "Tamil", "tam", "tamil", "English", "eng", "english",
    "Telugu", "tel", "telugu", "Malayalam", "mal", "malayalam", "Kannada", "kan", "kannada",
    "Marathi", "mar", "marathi", "Punjabi", "pun", "punjabi", "Bengoli", "beng", "bengoli",
    "Gujrati", "guj", "gujrati", "gujarati", "Korean", "kor", "korean", "Spanish", "spa", "spanish",
    "French", "fre", "french", "German", "ger", "german", "Chinese", "chi", "chinese",
    "Arabic", "ara", "arabic", "Portuguese", "por", "portuguese", "Russian", "rus", "russian",
    "Japanese", "jap", "japanese", "Odia", "ori", "odia", "Assamese", "ass", "assamese", "Urdu", "urd", "urdu"
]

UPDATE_CAPTION = """<b>🎉 Streaming Now 🎉</b>
...
@Client.on_message(filters.chat(MOVIE_UPDATE_CHANNEL) & media_filter)
...
async def send_movie_update(bot, file_name, files):
    ...
    caption = UPDATE_CAPTION.format(f"{kind} {title}", year or "Unknown", language, quality_text)
    ...
    try:
        ...
        await bot.send_message(LOG_CHANNEL, f"❌ MCU POST ERROR: {e}")
...
async def movie_name_format(file_name):
    return re.sub(r'[^A-Za-z0-9\s]', '', file_name.replace("_", " ")).strip()
